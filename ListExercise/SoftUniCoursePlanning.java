        ...
        while (!input.equals("course start")) {
            ...
            switch (command) {
                ...
                case "Swap":
                    ...
                    String firstLessonExercises = lessonTitle + "-Exercise";
                    String secondLessonExercises = swapWithLesson + "-Exercise";
                    ...
                    if (schedule.contains(firstLessonExercises)) {
                        schedule.remove(firstLessonExercises);
                        schedule.add(schedule.indexOf(lessonTitle) + 1, firstLessonExercises);
                    }
                    if (schedule.contains(secondLessonExercises)) {
                        schedule.remove(secondLessonExercises);
                        schedule.add(schedule.indexOf(swapWithLesson) + 1, secondLessonExercises);
                    }
                    break;
                case "Exercise":
